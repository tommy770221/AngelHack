...
public class FacebookToToken {
     ...
     public String changeCode(String code) throws IOException {
         ...
         Request request = new Request.Builder()
                 .url("https://graph.facebook.com/v2.10/oauth/access_token?client_id=368897760172030%0A&redirect_uri=http%3A%2F%2F192.168.1.116%3A8080%2FAngelHack%2FgetFBCode&client_secret=921a94223f3f0f147196b46ba1a6761e&code="+code)
                 .get()
